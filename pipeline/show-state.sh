#!/bin/bash
# Show state for a layer
# Usage: ./show-state.sh <layer-name> [environment]
# Example: ./show-state.sh 100-network dev
...
log_info "Showing state for layer: ${LAYER} (environment: ${ENVIRONMENT})"
