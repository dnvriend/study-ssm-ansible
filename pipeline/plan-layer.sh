#!/bin/bash
# Plan a single layer
# Usage: ./plan-layer.sh <layer-name> [environment]
# Example: ./plan-layer.sh 100-network dev
...
log_info "Planning layer: ${LAYER} (environment: ${ENVIRONMENT})"
...
log_success "Plan complete for ${LAYER}"
